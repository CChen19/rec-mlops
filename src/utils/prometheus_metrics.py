...
# Model load status
models_loaded = Gauge(
    "recommendation_api_models_loaded", "Number of loaded models", registry=_registry
)

# Cache hit ratio
cache_hits = Counter("recommendation_api_cache_hits_total", "Cache hits", registry=_registry)

cache_misses = Counter("recommendation_api_cache_misses_total", "Cache misses", registry=_registry)
